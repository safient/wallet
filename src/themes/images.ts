export const images = {
  ...
  createWallet: require('../assets/images/create-wallet.png').default,
  claimWallet: require('../assets/images/claim-wallet.png').default,
  accessWallet: require('../assets/images/access-wallet.png').default,
};
